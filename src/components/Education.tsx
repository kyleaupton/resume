    ...
    <View style={({ flexDirection: 'column', gap: 12 })}>
      <View style={({ gap: 4 })}>
        <View style={({ flexDirection: 'row', alignItems: 'center', gap: 8 })}>
          ...
          <View style={({ flexDirection: 'row', gap: 4 })}>
            <CircleExclamation />
            <Text style={({ fontSize: 11 })}>Incomplete</Text>
          </View>
        </View>
        ...
        <View style={({ flexDirection: 'row', justifyContent: 'space-between', marginTop: -10 })}>
          ...
          <View style={({ alignItems: 'flex-end' })}>
            <Text style={({ ...styles.extraTextSmall, marginBottom: 1 })}>Marietta, GA</Text>
            <Text style={({ ...styles.extraTextSmall, marginBottom: 1 })}>2018 - 2021</Text>
          </View>
        </View>

        <View style={({ padding: '0 12px' })}>
          <Text style={styles.text}>Completed Relevant Courses</Text>
          {renderedCourses}
        </View>
      </View>
      ...
      <View style={({ gap: 4 })}>
        <View style={({ flexDirection: 'row', justifyContent: 'space-between', marginBottom: -6 })}>
          ...
          <View style={({ alignItems: 'flex-end' })}>
            <Text style={({ ...styles.extraTextSmall, marginBottom: 1 })}>Suwanee, GA</Text>
